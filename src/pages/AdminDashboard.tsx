...
import { Trash2, Edit, Plus, Upload, X, Settings, Users, FileText, Image, Video } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col dark:bg-gray-900">
      ...
      <div className="flex-1 container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">Manage your platform settings and content</p>
        </div>
          ...
          <TabsContent value="pricing" className="space-y-6">
            <Card className="dark:bg-gray-800 dark:border-gray-700">
              ...
              <CardContent>
                ...
                {/* Edit Plan Modal - keeping existing modal code */}
                {editingPlan && (
          ...
          <TabsContent value="content" className="space-y-6">
            <Card className="dark:bg-gray-800 dark:border-gray-700">
              ...
              <CardContent>
                ...
                {/* Edit Post Modal - keeping existing modal code */}
                {editingPost && (
                  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          ...
          <TabsContent value="media" className="space-y-6">
            <Card className="dark:bg-gray-800 dark:border-gray-700">
              ...
              <CardContent>
                ...
                {/* Edit Gallery Item Modal - keeping existing modal code */}
                {editingGallery && (
                  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          ...
          <TabsContent value="users" className="space-y-6">
            <Card className="dark:bg-gray-800 dark:border-gray-700">
              <CardHeader>
                ...
                <CardDescription className="dark:text-gray-300">Manage platform users and permissions</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-12">
                  <Users className="h-12 w-12 mx-auto text-gray-400 mb-4" />
                  <h3 className="text-lg font-medium text-gray-600 dark:text-gray-300 mb-2">User Management Coming Soon</h3>
                  <p className="text-gray-500 dark:text-gray-400">This feature will be available in a future update.</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
